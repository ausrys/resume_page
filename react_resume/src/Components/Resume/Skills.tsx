      ...
      <div>
        <div className="py-1 px-2">
          <div className="border-b-2 pb-2">
            ...
            <span>
              Node.js, Python for services, REST API creation, scripting, and
              automation for system tasks and integrations
            </span>
          </div>
          <div className="border-b-2 pb-2">
          ...
          <div className="border-b-2 pb-2">
            ...
            <span>
              React, TypeScript, JavaScript (ES6), HTML5, CSS3 (used mainly for
          ...
          <div className="border-b-2 pb-2">
            ...
            <span>
              ...
              application and config data
            </span>
          </div>
          <div className="border-b-2 pb-2">
            <h3 className="text-xl my-2 font-bold">Testing & Debugging:</h3>
            <span>
              Postman, Chrome DevTools, writing and running test cases (pytest,
              jest)
            </span>
          </div>
          <div className="border-b-2 pb-2">
            ...
            <span>
              Kibana, SolarWinds, log inspection, alert optimization, and basic
